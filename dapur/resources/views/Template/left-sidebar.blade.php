               ...
               with font-awesome or any other icon font library -->
                ...
                <li class="nav-item has-treeview {{ Request::is('resep*') || Request::is('mastermenu*') || Request::is('master_satuan*') || Request::is('master_bahan*') ? 'menu-open' : '' }}">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        @if (auth()->user()->level == "pengadaan" || "admin")
                        <li class="nav-item">
                            <a href="{{ route('mastermenu.index') }}" class="nav-link {{ Request::is('mastermenu*') ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Pengajuan menu</p>
                            </a>
                        </li>
                ...
                <li class="nav-item has-treeview">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('bahanmasak.index') }}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Bahan Masak</p>
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a href="{{ route('stokgudang.index') }}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Stok Gudang</p>
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a href="{{ route('menubahan.index') }}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Menu Bahan</p>
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a href="{{ route('apilogs.index') }}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Api Logs</p>
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a href="{{ route('pengajuandapur.index') }}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Pengajuan Dapur</p>
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a href="{{ route('pengajuanpo.index') }}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Pengajuan PO</p>
                            </a>
                        </li>
