                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form action="{{ route('pengajuanpo.store') }}" method="POST">
                                        @csrf

                                        <div class="form-group mb-3">
                                            <label class="font-weight-bold">Nomor Pengajuan</label>
                                            <input type="text" class="form-control @error('nomor_pengajuan') is-invalid @enderror" name="nomor_pengajuan" step="any" placeholder="Nomor Pengajuan">
                                        ...
                                        <div class="form-group mb-3">
                                            <label class="font-weight-bold">Total Pengajuan</label>
                                            <input type="text" class="form-control @error('total_pengajuan') is-invalid @enderror" name="total_pengajuan" step="any" placeholder="---">
