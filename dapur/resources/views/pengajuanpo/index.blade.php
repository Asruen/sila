...
<body class="hold-transition sidebar-mini">
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    <h3 class="card-title">
                                        <a href="{{ route('pengajuanpo.create') }}" class="btn btn-primary btn-sm">
                                            Tambah Data
                                        </a>
                                        <br><br>
                                        <form action="{{ url('/export-pengajuanpo') }}" method="GET" class="d-flex">
                                ...
                                <div class="card-body">
                                    <table id="tbl_list_data_pengajuan_po" class="table table-bordered table-hover">
                                        <thead>
                                            <tr>
                                                <th>No</th>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            var table = $('#tbl_list_data_pengajuan_po').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('pengajuanpo.index') }}",
                columns: [
                    { data: 'DT_RowIndex', name: 'DT_RowIndex', orderable: false, searchable: false },
                    { data: 'nomor_pengajuan', name: 'nomor_pengajuan' },
                    { data: 'total_pengajuan', name: 'total_pengajuan' },
            ...
            function updateStatus(id, status, keterangan) {
                $.ajax({
                    url: '{{ route('pengajuanpo.updateStatus') }}',
                    type: 'POST',
                    data: {
                        _token: '{{ csrf_token() }}',
                        id: id,
