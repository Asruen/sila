            ...
            <section class="content">
                <div class="container-fluid">
                    ...
                    <div class="col-12">
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                            <h3 class="card-title"><a href="{{ route('master_bahan.create') }}" class="edit btn btn-primary btn-sm " id="btn-edit-post">Tambah</a></h3>
                            <table id="tbl_list_master_bahan" class="table table-bordered table-hover">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>bahan</th>
