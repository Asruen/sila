...
class TbMasterResepController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('office/masterresep.index', compact('header'));
    }
    ...
    public function edit(string $id): View
    {
        ...
        return view('office/masterresep.edit', compact('Resep', 'karbohidrat', 'protein', 'sayur','buah','susu', 'header'));
    }
    ...
    public function create(): View
    {
        ...
        //render view with product
        return view('office/masterresep.create', compact('Resep', 'karbohidrat', 'protein', 'sayur', 'buah', 'susu', 'header'));
    ...
    // rincian sekolah 
    public function index_rincian_sekolah_harian(string $idmenu): View
    {
        $header = "rincian sekolah harian Resep";
        //get product by ID
        $menu = Menu::findOrFail($idmenu);
        

        //render view with product
        return view('office/masterresep.edit', compact('menu'));
    }
}
