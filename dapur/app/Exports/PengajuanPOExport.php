...
class PengajuanPoExport implements FromCollection, WithHeadings, WithStyles, WithCustomStartCell, WithMapping
{
    ...
    public function collection()
    {
        ...
        return PengajuanPO::whereBetween('created_at', [$start_datea, $end_datea])
            ->get();
    }
