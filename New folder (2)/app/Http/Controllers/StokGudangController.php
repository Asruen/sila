...
class StokGudangController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('stokgudang.index', ['header' => 'Master Stok Gudang']);
    }
    ...
    public function create()
    {
        $bahan = DB::table('tb_master_bahan')
                ...
                ->get();
        $satuan = TbSatuan::all();
        return view('stokgudang.create', ['header' => 'Tambah Stok Gudang'], compact('bahan', 'satuan'));
    }
    ...
    public function edit($id)
    {
        ...
        $satuan = TbSatuan::all();
        return view('stokgudang.edit',['header' => 'Edit Stok Gudang'], compact('stokgudang', 'bahan', 'satuan'));
    }
