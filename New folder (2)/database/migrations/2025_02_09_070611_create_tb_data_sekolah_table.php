...
class CreateTbDataSekolahTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('tb_data_sekolah', function (Blueprint $table) {
            ...
            $table->timestamps();
            $table->foreign('jenjang_sekolah')->references('id')->on('tb_tingkatan_sekolah')->onDelete('cascade');
            $table->foreign('id_dapur')->references('id')->on('tb_data_dapur')->onDelete('cascade');
        });
    }
